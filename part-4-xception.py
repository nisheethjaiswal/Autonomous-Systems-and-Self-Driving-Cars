...
from tensorflow.keras.layers import Dense, AveragePooling2D, Conv2D, Activation, Flatten, GlobalAveragePooling2D
...
class DQNAgent:
    ...
    def create_model(self):
		# Load Xception and then load imagenet weights
		base_model = Xception(weights="imagenet", include_top=False, input_shape=(IM_HEIGHT, IM_WIDTH,3))
		x = base_model.output
